...
<div class="d-flex align-items-center gap-2 mb-4">
    ...
    <div>
        <h5 class="mb-0 fw-semibold">Detail Karyawan</h5>
        <small class="text-muted">Informasi lengkap dan riwayat karyawan</small>
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card table-card mt-3 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between
                ...
                <div>
                    <code class="text-dark">{{ $card->uid }}</code>
    ...
    <div class="col-md-8">
        ...
        <div class="card table-card mb-3">
            <div class="card-header bg-white d-flex justify-content-between
                ...
                <a href="{{ route('hrd.attendances.show', $employee) }}"
